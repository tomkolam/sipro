...
DEFAULTS: dict = {d["key"]: d for d in [
    ...
    _d("lead.sla_hours", {"acquisition": 0.25, "nurturing": 48, "appointment": 72,
                          "booking": 168, "spr": 168}, "obj", "lead",
       "SLA tindak lanjut per tahap (jam)",
       "Batas waktu tindak lanjut tiap tahap; lewat batas memicu eskalasi ke supervisor."),
    ...
    _d("budget.enforce_cost_ref", True, "bool", "anggaran",
       ...
       "Tanpa ini realisasi RAB & overbudget tidak bisa dihitung tanpa menebak.",
       sensitive=True),
    ...
    _d("permit.block_build_without", [], "list", "konstruksi",
       ...
       "Kosong = hanya peringatan. Isi kode izin (mis. PBG) untuk memblokir."),
    _d("build.require_dp_before_start", True, "bool", "konstruksi",
...
GROUP_LABELS = {
    "reservasi": "Reservasi & Keep Unit", "lead": "Lead & SLA",
