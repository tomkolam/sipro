...
def main():
    ...
    lead_js = read("components/sales/LeadDetail.js")
    cust_js = read("components/customers/CustomerDetailSheet.js")
    check("checklist terpasang di layar Lead", "DocChecklist" in lead_js
          and 'entityType="lead"' in lead_js)
    check("checklist terpasang di layar Pelanggan", "DocChecklist" in cust_js
          and 'entityType="customer"' in cust_js)
