...
import AttributionPanel from "@/components/omni/AttributionPanel";
  ...
  return (
    <div data-testid={OMNI.page} className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        atribusi iklan, dan antrean penyelamatan lead yang gagal masuk.
      ...
      <Tabs defaultValue="rules" className="w-full">
        <TabsList>
          ...
          <TabsTrigger data-testid={OMNI.tabAttribution} value="attribution">Atribusi</TabsTrigger>
